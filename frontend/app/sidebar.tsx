        ...
        <div className="z-10 text-white justify-between flex-col p-9 place-items-start w-full hidden sm:flex sm:max-w-[50px] md:max-w-[100px] lg:max-w-[200px] h-full">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className='flex gap-5'>
                    <House />
                    <Link href="/" className='hidden lg:flex'>Home</Link>    
                </div>

                <div className='flex gap-5'>    
                   <Sparkles />
                    <Link href="/generate" className='hidden lg:flex'>Generate</Link>
                </div>

                <div className='flex gap-5'>    
                   <Images />
                    <Link href="/gallery" className='hidden lg:flex'>Gallery</Link>
                </div>
                            
                {/* <div className='flex gap-5'>
                    <User />
                    <Link href="/login" className='hidden lg:flex'>Log In</Link>
                </div>

                <div className='flex gap-5'>
                    <Globe />
                    <Link href="/subscribe" className='hidden lg:flex'>Subscribe</Link>
                </div>

                <div className='flex gap-5'>
                    <Settings />
                    <Link href="/settings" className='hidden lg:flex'>Settings</Link>
                </div> */}
